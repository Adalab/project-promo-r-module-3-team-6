  ...
  return (
    <section className="preview">
      ...
      <article className="preview__article">
        <div
          className={`preview__box1 palette${props.person.palette}-color2 js_preview_box1`}
        >
          <p
            className={`preview__box1__name palette${props.person.palette}-color1 js_preview_name`}
          >
        ...
        <nav className="preview__nav">
          <ul className="preview__media">
            <li
              className={`preview__media__item palette${props.person.palette}-color3  js_media_item`}
            >
              <a
                href={`tel:+34 ${props.person.phone}`}
