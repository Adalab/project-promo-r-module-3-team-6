  ...
  return (
    <>
      ...
      <section className='form__collapsible js_share_section'>
        ...
        <a href={props.dataResult.success && props.dataResult.cardURL}>   {props.dataResult.success ? props.dataResult.cardURL : props.dataResult.error}</a>
        <a href={props.dataResult.success && `https://twitter.com/intent/tweet?text=Mira%20mi%20super%20tarjeta%20de%20visita%20creada%20con%20StarCards&url=${props.dataResult.cardURL}`} className='form__collapsible__shareBtn js_twitter_btn'>
